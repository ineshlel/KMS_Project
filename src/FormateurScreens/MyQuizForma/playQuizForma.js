...
import QuizForma  from './quizForma';
import {
  StyleSheet,
  StatusBar,
  TouchableOpacity,
...
/* <View style={styles.toolbar}>
                    ...
                    <Text style={styles.toolbarTitle}>QCM</Text>
...
export default class PlayquizForma extends Component {
  constructor(props){
    super(props)
    this.state = {
      quizFinish : false,
  ...
  render() {
    return (
      ...
      <StatusBar barStyle="light-content"/>
       ...
       </View> :  <QuizForma quizFinish={(score) => this._quizFinish(score)} /> }
       <TouchableOpacity  onPress={ () =>navigation.navigate("QCMForma")}>
