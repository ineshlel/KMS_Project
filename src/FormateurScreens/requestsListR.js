...
export default class RequestsListR extends React.Component{
constructor(props){
super(props)
  this.intervalID,
 this.state={
...
getDemandes=async()=>{
    ...
    fetch(apiConfig.url+`/api/demandes_formateur?statut=R&programme=${this.props.id_pg}&formateur=${decoded.user_id}`, {
      method: 'GET',
      headers: {
