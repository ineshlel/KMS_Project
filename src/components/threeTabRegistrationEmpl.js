...
import ParticipantList from './listeParticipant';
import ParticipantListAcc from './listParticipantAcc';
import ParticipantListRef from './listParticipantRefs';


const { width } = Dimensions.get('window');

export default class ThreeTabRegistrationEmpl extends Component {
  constructor(props){
    super(props)
  this.state = {
    active: 0,
...
justifyContent: 'center',
  ...
  textStyle:{
    color:'#fff',
    fontSize:16,fontFamily:'Cairo-SemiBold'
